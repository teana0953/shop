<template>
<div class="component">
    <!-- <h3>You may view the Product Details here</h3>
    <p>Many Details</p>
    <p>Title: {{ title }}</p>
    ...
    <div class="panel panel-success">
        ...
        <div class="panel-body">
            ...
            <div class="pull-right">
                <button class="btn btn-success" @click="buyStock" :disabled="insufficientFunds || quantity <= 0 || !Number.isInteger(quantity)">{{ insufficientFunds ? 'Insufficient Funds' : 'Buy' }}
                </button>
            </div>
        </div>
    ...
    <!-- <article class="card product-item">
        <header class="card__header">
            <h1 class="product__title">Title: {{ title }}</h1>
            <h1 class="product__title">Id: {{ id }}</h1>
        </header>
